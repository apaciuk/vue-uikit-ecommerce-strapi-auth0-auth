					 ...
					 <ul class="uk-subnav" data-uk-margin>
						  <li class="uk-visible@s"><NuxtLink to="/" exact>Home</NuxtLink></li>
							...
							<li class="uk-visible@s"><NuxtLink to="/contact">Collections</NuxtLink></li>
								  <li class="uk-visible@s"><NuxtLink to="/contact">Categories</NuxtLink></li>
							<li class="uk-visible@s"><NuxtLink to="/contact">Best Sellers</NuxtLink></li>
									  <li class="uk-visible@s"><NuxtLink to="/contact">Instagram</NuxtLink></li>
							<li class="uk-visible@s"><NuxtLink to="/contact">Trending</NuxtLink></li>
								  <li class="uk-visible@s"><NuxtLink to="/contact">Sale</NuxtLink></li>
